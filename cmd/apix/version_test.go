...
func TestPrintVersionUsesBuildMetadata(t *testing.T) {
	...
	version, commit, date = "0.6.0", "abc1234", "2026-06-14T12:00:00Z"
	t.Cleanup(func() {
	...
	if actual := strings.TrimSpace(string(output)); actual != "apix 0.6.0 (commit abc1234, built 2026-06-14T12:00:00Z)" {
